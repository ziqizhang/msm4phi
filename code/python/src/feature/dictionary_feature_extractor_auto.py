...
if __name__ == "__main__":
    ...
    outfolder = "/home/zz/Work/msm4phi_data/paper2/reported/features/paper_reported/" \
                "baseline_empty_profile_filled(tweets)/dictionary_feature_1"
    ...
    postype_dictionaries = \
        de.load_extracted_dictionary(
            dictionary_folder + "/auto_created/profile_tweets/" + dict_lemstem_option + "/frequency_pass2",
