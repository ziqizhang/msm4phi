...
public class StatsCleaner {
    ...
    private static final int[] REMOVE_COLS_CONTENT={0,1};
    private static final int[] REMOVE_COLS_INTERACTION={0,1,6,7,8};
    private static final int[] REMOVE_COLS_USER={0,1,6,10,14,18};
